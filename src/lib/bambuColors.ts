// Hex values marked (exact) were provided by the user from actual invoices.
...
export const BAMBU_COLOR_MAP: Record<string, string> = {
  ...
  '11102': '#FFF8E7', // Cream
  '11103': '#F5F0E8', // Ivory White (exact)
  ...
  '11202': '#E82020', // Red
  '11203': '#FF3B3B', // Fire Red
  '11204': '#CC2C2C', // Bambu Red
  ...
  // Yellows
  '11400': '#F5C842', // Lemon Yellow (exact)
  '11401': '#FFE135', // Banana Yellow
